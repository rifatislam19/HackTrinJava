...
*/
    ...
    *  as an argument. It can handle action keys
    ...
    public static void drawComplexNumber(ComplexNumber c) {
      double x = c.getReal();
      double y = c.getImaginary();
      StdDraw.line(0.5,0.5,0.5+x/2,0.5+y/2);
    }
    ...
    public static void main(String[] args) {
      ...
      StdDraw.text(0.5,0.02,"-1");
      StdDraw.text(0.5,0.98,"1");
      StdDraw.text(0.02,0.5,"-1");
      StdDraw.text(0.98,0.5,"1");
